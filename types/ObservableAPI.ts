...
export class ObservableAuthApi {
     ...
     * @param [authInputDto]
     */
    public authenticateWithHttpInfo(authInputDto?: AuthInputDto, _options?: ConfigurationOptions): Observable<HttpInfo<AuthOutputDto>> {
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.authenticate(authInputDto, _config);
        // build promise chain
     ...
     * @param [authInputDto]
     */
    public authenticate(authInputDto?: AuthInputDto, _options?: ConfigurationOptions): Observable<AuthOutputDto> {
...
export class ObservableAutoJobApi {
     ...
     * @param [autoJobGetDto]
     */
    public deleteOneAutoJobWithHttpInfo(autoJobGetDto?: AutoJobGetDto, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.deleteOneAutoJob(autoJobGetDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [autoJobGetDto]
     */
    public deleteOneAutoJob(autoJobGetDto?: AutoJobGetDto, _options?: ConfigurationOptions): Observable<boolean> {
        return this.deleteOneAutoJobWithHttpInfo(autoJobGetDto, _options).pipe(map((apiResponse: HttpInfo<boolean>) => apiResponse.data));
    }

    /**
     */
    public getAllAutoJobsWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<AutoJobConfigDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllAutoJobs(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getAllAutoJobs(_options?: ConfigurationOptions): Observable<Array<AutoJobConfigDto>> {
     ...
     * @param [autoJobPutDto]
     */
    public updateOneAutoJobWithHttpInfo(autoJobPutDto?: AutoJobPutDto, _options?: ConfigurationOptions): Observable<HttpInfo<AutoJobConfigDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.updateOneAutoJob(autoJobPutDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [autoJobPutDto]
     */
    public updateOneAutoJob(autoJobPutDto?: AutoJobPutDto, _options?: ConfigurationOptions): Observable<AutoJobConfigDto> {
...
export class ObservableConfigApi {
    ...
    /**
     */
    public getGlobalConfigWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<DynamicConfigDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getGlobalConfig(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getGlobalConfig(_options?: ConfigurationOptions): Observable<DynamicConfigDto> {
     ...
     */
    public updateGlobalConfigWithHttpInfo(globalConfigPutDto?: GlobalConfigPutDto, _options?: ConfigurationOptions): Observable<HttpInfo<DynamicConfigDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.updateGlobalConfig(globalConfigPutDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [globalConfigPutDto]
     */
    public updateGlobalConfig(globalConfigPutDto?: GlobalConfigPutDto, _options?: ConfigurationOptions): Observable<DynamicConfigDto> {
...
export class ObservableDataApi {
    ...
    /**
     */
    public apiDatasGetWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<DataPointDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiDatasGet(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public apiDatasGet(_options?: ConfigurationOptions): Observable<Array<DataPointDto>> {
     ...
     * @param pointName
     */
    public apiDatasPointUserPointNameDeleteWithHttpInfo(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiDatasPointUserPointNameDelete(pointUser, pointName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param pointName
     */
    public apiDatasPointUserPointNameDelete(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     * @param pointName
     */
    public apiDatasPointUserPointNameGetWithHttpInfo(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<HttpInfo<DataPointDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiDatasPointUserPointNameGet(pointUser, pointName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param pointName
     */
    public apiDatasPointUserPointNameGet(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<DataPointDto> {
     ...
     * @param [maxBytes]
     */
    public apiDatasPointUserPointNamePutWithHttpInfo(pointUser: string, pointName: string, maxBytes?: number, _options?: ConfigurationOptions): Observable<HttpInfo<DataPointDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiDatasPointUserPointNamePut(pointUser, pointName, maxBytes, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [maxBytes]
     */
    public apiDatasPointUserPointNamePut(pointUser: string, pointName: string, maxBytes?: number, _options?: ConfigurationOptions): Observable<DataPointDto> {
     ...
     * @param [user]
     */
    public apiDatasPointUserPointNameSharesDeleteWithHttpInfo(pointUser: string, pointName: string, user?: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiDatasPointUserPointNameSharesDelete(pointUser, pointName, user, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [user]
     */
    public apiDatasPointUserPointNameSharesDelete(pointUser: string, pointName: string, user?: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     * @param [user]
     */
    public apiDatasPointUserPointNameSharesGetWithHttpInfo(pointUser: string, pointName: string, user?: string, _options?: ConfigurationOptions): Observable<HttpInfo<Array<DataPointShareDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiDatasPointUserPointNameSharesGet(pointUser, pointName, user, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [user]
     */
    public apiDatasPointUserPointNameSharesGet(pointUser: string, pointName: string, user?: string, _options?: ConfigurationOptions): Observable<Array<DataPointShareDto>> {
     ...
     */
    public apiDatasPointUserPointNameSharesPutWithHttpInfo(pointUser: string, pointName: string, dataPointShareDto?: DataPointShareDto, _options?: ConfigurationOptions): Observable<HttpInfo<DataPointShareDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiDatasPointUserPointNameSharesPut(pointUser, pointName, dataPointShareDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [dataPointShareDto]
     */
    public apiDatasPointUserPointNameSharesPut(pointUser: string, pointName: string, dataPointShareDto?: DataPointShareDto, _options?: ConfigurationOptions): Observable<DataPointShareDto> {
     ...
     * @param [maxBytes]
     */
    public apiDatasPostWithHttpInfo(name?: string, maxBytes?: number, _options?: ConfigurationOptions): Observable<HttpInfo<DataPointDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiDatasPost(name, maxBytes, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [maxBytes]
     */
    public apiDatasPost(name?: string, maxBytes?: number, _options?: ConfigurationOptions): Observable<DataPointDto> {
     ...
     */
    public browseFilesForDataWithHttpInfo(dataPointBrowseGetDto?: DataPointBrowseGetDto, _options?: ConfigurationOptions): Observable<HttpInfo<Array<FileDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.browseFilesForData(dataPointBrowseGetDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [dataPointBrowseGetDto]
     */
    public browseFilesForData(dataPointBrowseGetDto?: DataPointBrowseGetDto, _options?: ConfigurationOptions): Observable<Array<FileDto>> {
     ...
     * @param [body]
     */
    public deleteOneFileForDataWithHttpInfo(body?: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.deleteOneFileForData(body, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [body]
     */
    public deleteOneFileForData(body?: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     * @param [body]
     */
    public dumpOneFileForDataWithHttpInfo(body?: string, _options?: ConfigurationOptions): Observable<HttpInfo<FileOutputDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.dumpOneFileForData(body, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [body]
     */
    public dumpOneFileForData(body?: string, _options?: ConfigurationOptions): Observable<FileOutputDto> {
     ...
     * @param pointName
     */
    public getAllJobsForDataWithHttpInfo(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<HttpInfo<Array<RepoDataJobDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllJobsForData(pointUser, pointName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param pointName
     */
    public getAllJobsForData(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<Array<RepoDataJobDto>> {
     ...
     * @param [filePutDto]
     */
    public updateOneFileForDataWithHttpInfo(filePutDto?: FilePutDto, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.updateOneFileForData(filePutDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [filePutDto]
     */
    public updateOneFileForData(filePutDto?: FilePutDto, _options?: ConfigurationOptions): Observable<boolean> {
...
export class ObservableInfoApi {
    ...
    /**
     */
    public getSystemSummaryWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<SystemStatusDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getSystemSummary(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getSystemSummary(_options?: ConfigurationOptions): Observable<SystemStatusDto> {
        return this.getSystemSummaryWithHttpInfo(_options).pipe(map((apiResponse: HttpInfo<SystemStatusDto>) => apiResponse.data));
    }

    /**
     */
    public getValidNotifyMethodsWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<string>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getValidNotifyMethods(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getValidNotifyMethods(_options?: ConfigurationOptions): Observable<Array<string>> {
        return this.getValidNotifyMethodsWithHttpInfo(_options).pipe(map((apiResponse: HttpInfo<Array<string>>) => apiResponse.data));
    }

    /**
     */
    public getValidNotifySubscriptionsWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<string>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getValidNotifySubscriptions(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getValidNotifySubscriptions(_options?: ConfigurationOptions): Observable<Array<string>> {
        return this.getValidNotifySubscriptionsWithHttpInfo(_options).pipe(map((apiResponse: HttpInfo<Array<string>>) => apiResponse.data));
    }

    /**
     */
    public getValidPermissionsWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<string>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getValidPermissions(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getValidPermissions(_options?: ConfigurationOptions): Observable<Array<string>> {
...
export class ObservableJobApi {
     ...
     * @param id
     */
    public cancelOneJobWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.cancelOneJob(id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public cancelOneJob(id: string, _options?: ConfigurationOptions): Observable<boolean> {
        return this.cancelOneJobWithHttpInfo(id, _options).pipe(map((apiResponse: HttpInfo<boolean>) => apiResponse.data));
    }

    /**
     */
    public getAllJobsWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<RepoDataJobDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllJobs(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getAllJobs(_options?: ConfigurationOptions): Observable<Array<RepoDataJobDto>> {
     ...
     * @param id
     */
    public getOneJobWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<RepoDataJobDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getOneJob(id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public getOneJob(id: string, _options?: ConfigurationOptions): Observable<RepoDataJobDto> {
     ...
     * @param [jobBackupDto]
     */
    public startOneBackupWithHttpInfo(jobBackupDto?: JobBackupDto, _options?: ConfigurationOptions): Observable<HttpInfo<RepoDataJobDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.startOneBackup(jobBackupDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [jobBackupDto]
     */
    public startOneBackup(jobBackupDto?: JobBackupDto, _options?: ConfigurationOptions): Observable<RepoDataJobDto> {
     ...
     * @param [jobRestoreDto]
     */
    public startOneRestoreWithHttpInfo(jobRestoreDto?: JobRestoreDto, _options?: ConfigurationOptions): Observable<HttpInfo<RepoDataJobDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.startOneRestore(jobRestoreDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [jobRestoreDto]
     */
    public startOneRestore(jobRestoreDto?: JobRestoreDto, _options?: ConfigurationOptions): Observable<RepoDataJobDto> {
...
export class ObservableLogApi {
     ...
     * @param id
     */
    public deleteOneLogWithHttpInfo(id: number, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.deleteOneLog(id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public deleteOneLog(id: number, _options?: ConfigurationOptions): Observable<boolean> {
        return this.deleteOneLogWithHttpInfo(id, _options).pipe(map((apiResponse: HttpInfo<boolean>) => apiResponse.data));
    }

    /**
     */
    public getAllLogsWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<LogItemDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllLogs(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getAllLogs(_options?: ConfigurationOptions): Observable<Array<LogItemDto>> {
     ...
     * @param id
     */
    public getOneLogWithHttpInfo(id: number, _options?: ConfigurationOptions): Observable<HttpInfo<LogItemDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getOneLog(id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public getOneLog(id: number, _options?: ConfigurationOptions): Observable<LogItemDto> {
...
export class ObservableMessageApi {
     ...
     * @param id
     */
    public deleteOneMessageWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.deleteOneMessage(id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public deleteOneMessage(id: string, _options?: ConfigurationOptions): Observable<boolean> {
        return this.deleteOneMessageWithHttpInfo(id, _options).pipe(map((apiResponse: HttpInfo<boolean>) => apiResponse.data));
    }

    /**
     */
    public getAllMessagesWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<MessageItemDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllMessages(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getAllMessages(_options?: ConfigurationOptions): Observable<Array<MessageItemDto>> {
     ...
     * @param id
     */
    public getOneMessageWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<MessageItemDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getOneMessage(id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public getOneMessage(id: string, _options?: ConfigurationOptions): Observable<MessageItemDto> {
     ...
     */
    public postOneMessageWithHttpInfo(messagePostDto?: MessagePostDto, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.postOneMessage(messagePostDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [messagePostDto]
     */
    public postOneMessage(messagePostDto?: MessagePostDto, _options?: ConfigurationOptions): Observable<boolean> {
...
export class ObservableNotificationApi {
     ...
     * @param id
     */
    public deleteOneNotificationWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.deleteOneNotification(id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public deleteOneNotification(id: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     * @param [body]
     */
    public deleteOneNotificationConfigWithHttpInfo(body?: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.deleteOneNotificationConfig(body, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [body]
     */
    public deleteOneNotificationConfig(body?: string, _options?: ConfigurationOptions): Observable<boolean> {
        return this.deleteOneNotificationConfigWithHttpInfo(body, _options).pipe(map((apiResponse: HttpInfo<boolean>) => apiResponse.data));
    }

    /**
     */
    public getAllNotificationConfigsWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<WSConfigItemDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllNotificationConfigs(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public getAllNotificationConfigs(_options?: ConfigurationOptions): Observable<Array<WSConfigItemDto>> {
     ...
     * @param [unreadOnly]
     */
    public getAllNotificationsWithHttpInfo(unreadOnly?: boolean, _options?: ConfigurationOptions): Observable<HttpInfo<Array<WSNotificationDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllNotifications(unreadOnly, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [unreadOnly]
     */
    public getAllNotifications(unreadOnly?: boolean, _options?: ConfigurationOptions): Observable<Array<WSNotificationDto>> {
     ...
     * @param id
     */
    public getOneNotificationWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<WSNotificationDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getOneNotification(id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public getOneNotification(id: string, _options?: ConfigurationOptions): Observable<WSNotificationDto> {
     ...
     */
    public updateOneNotificationConfigWithHttpInfo(wSConfigPutDto?: WSConfigPutDto, _options?: ConfigurationOptions): Observable<HttpInfo<WSConfigItemDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.updateOneNotificationConfig(wSConfigPutDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [wSConfigPutDto]
     */
    public updateOneNotificationConfig(wSConfigPutDto?: WSConfigPutDto, _options?: ConfigurationOptions): Observable<WSConfigItemDto> {
...
export class ObservableRepoApi {
    ...
    /**
     */
    public apiReposGetWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<RepoPointDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiReposGet(_config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
    ...
    /**
     */
    public apiReposGet(_options?: ConfigurationOptions): Observable<Array<RepoPointDto>> {
     ...
     * @param pointName
     */
    public apiReposPointUserPointNameDeleteWithHttpInfo(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiReposPointUserPointNameDelete(pointUser, pointName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param pointName
     */
    public apiReposPointUserPointNameDelete(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     * @param pointName
     */
    public apiReposPointUserPointNameGetWithHttpInfo(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<HttpInfo<RepoPointDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiReposPointUserPointNameGet(pointUser, pointName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param pointName
     */
    public apiReposPointUserPointNameGet(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<RepoPointDto> {
     ...
     * @param [maxBytes]
     */
    public apiReposPointUserPointNamePutWithHttpInfo(pointUser: string, pointName: string, maxBytes?: number, _options?: ConfigurationOptions): Observable<HttpInfo<RepoPointDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiReposPointUserPointNamePut(pointUser, pointName, maxBytes, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [maxBytes]
     */
    public apiReposPointUserPointNamePut(pointUser: string, pointName: string, maxBytes?: number, _options?: ConfigurationOptions): Observable<RepoPointDto> {
     ...
     * @param [user]
     */
    public apiReposPointUserPointNameSharesDeleteWithHttpInfo(pointUser: string, pointName: string, user?: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiReposPointUserPointNameSharesDelete(pointUser, pointName, user, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [user]
     */
    public apiReposPointUserPointNameSharesDelete(pointUser: string, pointName: string, user?: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     * @param [user]
     */
    public apiReposPointUserPointNameSharesGetWithHttpInfo(pointUser: string, pointName: string, user?: string, _options?: ConfigurationOptions): Observable<HttpInfo<Array<RepoPointShareDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiReposPointUserPointNameSharesGet(pointUser, pointName, user, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [user]
     */
    public apiReposPointUserPointNameSharesGet(pointUser: string, pointName: string, user?: string, _options?: ConfigurationOptions): Observable<Array<RepoPointShareDto>> {
     ...
     */
    public apiReposPointUserPointNameSharesPutWithHttpInfo(pointUser: string, pointName: string, repoPointShareDto?: RepoPointShareDto, _options?: ConfigurationOptions): Observable<HttpInfo<RepoPointShareDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiReposPointUserPointNameSharesPut(pointUser, pointName, repoPointShareDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [repoPointShareDto]
     */
    public apiReposPointUserPointNameSharesPut(pointUser: string, pointName: string, repoPointShareDto?: RepoPointShareDto, _options?: ConfigurationOptions): Observable<RepoPointShareDto> {
     ...
     * @param [maxBytes]
     */
    public apiReposPostWithHttpInfo(name?: string, maxBytes?: number, _options?: ConfigurationOptions): Observable<HttpInfo<RepoPointDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.apiReposPost(name, maxBytes, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [maxBytes]
     */
    public apiReposPost(name?: string, maxBytes?: number, _options?: ConfigurationOptions): Observable<RepoPointDto> {
     ...
     * @param [dataPointBrowseGetDto]
     */
    public browseFilesForRepoWithHttpInfo(dataPointBrowseGetDto?: DataPointBrowseGetDto, _options?: ConfigurationOptions): Observable<HttpInfo<Array<FileDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.browseFilesForRepo(dataPointBrowseGetDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [dataPointBrowseGetDto]
     */
    public browseFilesForRepo(dataPointBrowseGetDto?: DataPointBrowseGetDto, _options?: ConfigurationOptions): Observable<Array<FileDto>> {
     ...
     * @param id
     */
    public deleteOneSnapshotForRepoWithHttpInfo(pointUser: string, pointName: string, id: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.deleteOneSnapshotForRepo(pointUser, pointName, id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public deleteOneSnapshotForRepo(pointUser: string, pointName: string, id: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     * @param [body]
     */
    public dumpFileForRepoWithHttpInfo(body?: string, _options?: ConfigurationOptions): Observable<HttpInfo<FileOutputDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.dumpFileForRepo(body, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [body]
     */
    public dumpFileForRepo(body?: string, _options?: ConfigurationOptions): Observable<FileOutputDto> {
     ...
     * @param pointName
     */
    public getAllJobsForRepoWithHttpInfo(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<HttpInfo<Array<RepoDataJobDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllJobsForRepo(pointUser, pointName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param pointName
     */
    public getAllJobsForRepo(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<Array<RepoDataJobDto>> {
     ...
     * @param pointName
     */
    public getAllSnapshotsForRepoWithHttpInfo(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<HttpInfo<Array<SnapshotDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllSnapshotsForRepo(pointUser, pointName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param pointName
     */
    public getAllSnapshotsForRepo(pointUser: string, pointName: string, _options?: ConfigurationOptions): Observable<Array<SnapshotDto>> {
     ...
     * @param id
     */
    public getOneSnapshotForRepoWithHttpInfo(pointUser: string, pointName: string, id: string, _options?: ConfigurationOptions): Observable<HttpInfo<SnapshotDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getOneSnapshotForRepo(pointUser, pointName, id, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param id
     */
    public getOneSnapshotForRepo(pointUser: string, pointName: string, id: string, _options?: ConfigurationOptions): Observable<SnapshotDto> {
...
export class ObservableUserApi {
     ...
     * @param [userCreateDto]
     */
    public createOneUserWithHttpInfo(userCreateDto?: UserCreateDto, _options?: ConfigurationOptions): Observable<HttpInfo<UserSummaryDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.createOneUser(userCreateDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [userCreateDto]
     */
    public createOneUser(userCreateDto?: UserCreateDto, _options?: ConfigurationOptions): Observable<UserSummaryDto> {
     ...
     * @param userName
     */
    public deleteOneUserWithHttpInfo(userName: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.deleteOneUser(userName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param userName
     */
    public deleteOneUser(userName: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     */
    public disableOnePermissionForUserWithHttpInfo(userName: string, permissionName: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.disableOnePermissionForUser(userName, permissionName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param permissionName
     */
    public disableOnePermissionForUser(userName: string, permissionName: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     * @param permissionName
     */
    public enableOnePermissionForUserWithHttpInfo(userName: string, permissionName: string, _options?: ConfigurationOptions): Observable<HttpInfo<boolean>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.enableOnePermissionForUser(userName, permissionName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param permissionName
     */
    public enableOnePermissionForUser(userName: string, permissionName: string, _options?: ConfigurationOptions): Observable<boolean> {
     ...
     * @param userName
     */
    public getAllPermissionsForUserWithHttpInfo(userName: string, _options?: ConfigurationOptions): Observable<HttpInfo<Array<UserPermission>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getAllPermissionsForUser(userName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param userName
     */
    public getAllPermissionsForUser(userName: string, _options?: ConfigurationOptions): Observable<Array<UserPermission>> {
    ...
    /**
     */
    public getAllUsersWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<Array<UserSummaryDto>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    /**
     */
    public getAllUsers(_options?: ConfigurationOptions): Observable<Array<UserSummaryDto>> {
     ...
     * @param permissionName
     */
    public getOnePermissionForUserWithHttpInfo(userName: string, permissionName: string, _options?: ConfigurationOptions): Observable<HttpInfo<UserPermission>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getOnePermissionForUser(userName, permissionName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param permissionName
     */
    public getOnePermissionForUser(userName: string, permissionName: string, _options?: ConfigurationOptions): Observable<UserPermission> {
     ...
     * @param userName
     */
    public getOneUserWithHttpInfo(userName: string, _options?: ConfigurationOptions): Observable<HttpInfo<UserSummaryDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.getOneUser(userName, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param userName
     */
    public getOneUser(userName: string, _options?: ConfigurationOptions): Observable<UserSummaryDto> {
     ...
     */
    public updateAllPermissionsForUserWithHttpInfo(userName: string, userPermissionDto?: Array<UserPermissionDto>, _options?: ConfigurationOptions): Observable<HttpInfo<Array<UserPermission>>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.updateAllPermissionsForUser(userName, userPermissionDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [userPermissionDto]
     */
    public updateAllPermissionsForUser(userName: string, userPermissionDto?: Array<UserPermissionDto>, _options?: ConfigurationOptions): Observable<Array<UserPermission>> {
     ...
     * @param [userPutDto]
     */
    public updateOneUserWithHttpInfo(userName: string, userPutDto?: UserPutDto, _options?: ConfigurationOptions): Observable<HttpInfo<UserSummaryDto>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.updateOneUser(userName, userPutDto, _config);
        // build promise chain
        let middlewarePreObservable = from<RequestContext>(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => middleware.pre(ctx)));
     ...
     * @param [userPutDto]
     */
    public updateOneUser(userName: string, userPutDto?: UserPutDto, _options?: ConfigurationOptions): Observable<UserSummaryDto> {
